...
export default function CaseStudyPage() {
      ...
      <main id="main-content">
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/portfolio" className="text-[#00E87B] hover:text-[#00D46F] transition-colors text-sm">
              Back to Portfolio
            </Link>
          </div>
        </div>
  ...
  return (
    <main id="main-content">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          <img
            ...
            alt=""
            className="w-full h-full object-cover img-dark opacity-20"
            aria-hidden="true"
          />
        ...
        >
          ...
          >
            <Link
              href="/portfolio"
              className="inline-flex items-center gap-2 text-[#5C5D72] hover:text-[#00E87B] transition-colors text-xs font-mono"
            >
          ...
          >
            ...
            <span className="text-[#5C5D72] text-xs">{study.url}</span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-[#9A9BB0] text-sm md:text-base max-w-3xl leading-relaxed"
          >
            {study.summary}
          </motion.p>
          ...
          >
            {study.metrics.map((metric) => (
              <div key={metric.label} className="flex items-baseline gap-2.5">
                ...
                <span className="text-[#5C5D72] text-xs">{metric.label}</span>
              </div>
            ))}
          </motion.div>
        </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-14">
                ...
                <div className="space-y-3 ml-0 md:ml-16">
                  {study.challenge.map((item, i) => (
                    <motion.div
                      ...
                      className="flex items-start gap-3.5 p-4 bg-[#16161F] border border-[#252533] rounded-xl hover-glow card-lift"
                    >
                      ...
                      <p className="text-[#9A9BB0] text-sm leading-relaxed">{item}</p>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
                ...
                <div className="space-y-3 ml-0 md:ml-16">
                  {study.solution.map((item, i) => (
                    <motion.div
                      ...
                      className="flex items-start gap-3.5 p-4 bg-[#16161F] border border-[#252533] rounded-xl hover-glow card-lift"
                    >
                      <div className="w-7 h-7 rounded-md flex items-center justify-center flex-shrink-0 mt-0.5 bg-[rgba(0,232,123,0.08)]">
                ...
                <div className="space-y-3 ml-0 md:ml-16">
                  {study.outcomes.map((item, i) => (
                    <motion.div
                      ...
                      className="flex items-start gap-3.5 p-4 bg-[#16161F] border border-[#252533] rounded-xl hover-glow card-lift"
                    >
                      <div className="w-7 h-7 rounded-md flex items-center justify-center flex-shrink-0 mt-0.5 bg-[rgba(16,185,129,0.08)]">
                        <svg className="w-3.5 h-3.5 text-[#10B981]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="space-y-6">
              ...
              <motion.div
                ...
                className="bg-[#16161F] border border-[#252533] rounded-2xl p-7 sticky top-28"
              >
                <h3 className="text-xs font-semibold text-[#00E87B] mb-5 tracking-widest uppercase font-mono">Technologies</h3>
                <div className="flex flex-wrap gap-1.5 mb-7">
                  {study.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="text-[10px] px-2.5 py-1.5 bg-[#0A0A0F] border border-[#252533] rounded-md text-[#5C5D72] hover:border-[rgba(0,232,123,0.2)] hover:text-[#9A9BB0] transition-colors"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <h3 className="text-xs font-semibold text-[#00E87B] mb-3 tracking-widest uppercase font-mono">Visit Live Site</h3>
                <a
                  href={`https://${study.url}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-[#EDEEF2] hover:text-[#00E87B] transition-colors text-xs"
                >
                  {study.url}
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="border-t border-[#252533] mt-7 pt-7">
                  <h3 className="text-xs font-semibold text-[#00E87B] mb-3 tracking-widest uppercase font-mono">Industry</h3>
                  <p className="text-[#9A9BB0] text-xs">{study.industry}</p>
                </div>

                <div className="border-t border-[#252533] mt-7 pt-7">
                  <h3 className="text-xs font-semibold text-[#00E87B] mb-3 tracking-widest uppercase font-mono">Client</h3>
                  <p className="text-[#9A9BB0] text-xs">{study.client}</p>
                </div>
              </motion.div>
            </div>
          </div>
      ...
      {/* Next Project */}
      <section className="py-16 bg-[#111118]/40 relative z-10" aria-label="Next case study">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            transition={{ duration: 0.6, ease: [0.32, 0.72, 0, 1] }}
          >
            <p className="text-[#5C5D72] text-xs font-mono tracking-wider mb-3">NEXT PROJECT</p>
            <Link
            ...
            >
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h2 className="text-2xl md:text-4xl font-bold group-hover:text-[#00E87B] transition-colors duration-200 mb-3">
                    {nextStudy.title}
                  </h2>
                  <div className="flex items-center gap-2 text-[#5C5D72] group-hover:text-[#00E87B] transition-colors">
